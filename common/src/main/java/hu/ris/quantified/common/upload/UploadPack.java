...
public class UploadPack {
    ...
    @Getter
    private String playerUniqueId = null;
    ...
    public UploadPack(String key, Map<String, Integer> data, String base64Icon, String playerName, String worldId, String playerUniqueId) {
        this.key = key;
